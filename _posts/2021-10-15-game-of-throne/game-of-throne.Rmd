...
knitr::include_graphics("preview2.jpg")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/jbkunst/blog/master/_posts/2019-04-23-got-animating-the-shifting-of-affiliations/images/notsogood.gif")
```
...
anim_save(
  animation = p, fps = 30, duration = 8*3, width = 1000, height = 800) filename = "got-shifting-gganimate.gif"
  )
```
...
knitr::include_graphics("https://github.com/jbkunst/blog/blob/master/_posts/2019-04-23-got-animating-the-shifting-of-affiliations/images/got-shifting-gganimate.gif")
```
